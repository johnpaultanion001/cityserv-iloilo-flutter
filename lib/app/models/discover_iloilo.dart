...
class DiscoverIloilo {
  ...
  static DiscoverIloilo sample() {
    return DiscoverIloilo(
      ...
      status: 'De la Rama st, Ilolilo City, 5000',
    );
  }

  DiscoverIloilo copyWith({
    String? title,
    String? description,
    String? status,
    String? imageUrl,
  ...
  factory DiscoverIloilo.fromMap(Map<String, dynamic> map) {
    return DiscoverIloilo(
  ...
  factory DiscoverIloilo.fromJson(String source) => DiscoverIloilo.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'DiscoverIloilo(title: $title, description: $description, status: $status, imageUrl: $imageUrl, reportType: $reportType, reportDate: $reportDate, resolvedDate: $resolvedDate)';
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is DiscoverIloilo &&
        other.title == title &&
